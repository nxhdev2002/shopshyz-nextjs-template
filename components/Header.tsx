  ...
  return (
    <div>
      ...
      <div className="top-middle flex justify-around flex-wrap">
        <div className="logo pt-3 lg:basis-1/4 justify-center	flex">
          <Link href="/">
            <img
        ...
        <div className="search py-3 basis-full lg:basis-1/3">
          <form>
            <label
              htmlFor="search"
        ...
        <div className="card py-2 lg:basis-1/4 justify-center	flex">
          ...
          <div id="dropdownNavbar" className="z-50 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
            <ul className="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
              ...
              <li aria-labelledby="dropdownNavbarLink">
                ...
                <div id="doubleDropdown" className="hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
